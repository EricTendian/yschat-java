...
public class YSC_gui extends javax.swing.JFrame {
    private YSChat yschat = new YSChat();
    private String ysDir;
    ...
    public YSC_gui() {
        ...
        try {
            ...
            if (!log.exists()) {log_out = new BufferedWriter(new FileWriter(log)); log_out.append("<HEAD><LINK REL=STYLESHEET HREF=\"ysc_colors.css\" TYPE=\"text/css\"></HEAD>");}
        ...
        try {
            file = new File(new URL("file:/"+System.getProperty("user.dir")+"/yschat.cfg").toURI());
            if (file.exists()) ysc_cfg(file);
            else {
        ...
        this.addWindowListener(new WindowAdapter() {@Override
            public void windowClosing(WindowEvent e) {
                try {
                    if (yschat.connected) log_out.append(messOut.getText()+yschat.format("Connection stopped at "+new SimpleDateFormat("[HH:mm:ss]").format(new Date()), "ys_chat_mess")+"</p>");
                    yschat.disconnect();
                } catch (IOException ex) {
                    //JOptionPane.showMessageDialog(this, "ERROR DISCONNECTING FROM SERVER\n"+ex, "YS_chat", JOptionPane.ERROR_MESSAGE);
                    System.out.println(ex);
                }
                try {log_out.close();} catch (IOException ex) {System.out.println(ex);}
                System.exit(0);
            }
        });
    }

    private void ysc_cfg(File file) throws FileNotFoundException, IOException, URISyntaxException {
        ...
        try {
            while ((line = input.readLine()) != null) {
                if (line.length() > 17) {
                    if (line.substring(0, 17).equals("YSDIR           =")) {
                        ...
                        try {
                            ...
                            try {
                                while ((line = input.readLine()) != null) {
                                    line = line.trim();
                                    if (line.substring(0, 10).equals("DEFAULTUSR")) {
                                        userBox.setText(line.substring(12, line.length() - 1));
                                    }
                    ...
                    else if (line.substring(0, 17).equals("SERVERNAME      =")) {
                        servernameBox.setText(line.substring(17));
                    }
                    else if (line.substring(0, 17).equals("YSVERSION       =")) {
                        versionBox.setText(line.substring(17));
                    }
                    else if (line.substring(0, 17).equals("YSCHATVERSION   =")) {
                        jOptionPane1.setMessage("YSChat [Java ed.] version " + line.substring(17) + " by erict15\nOriginal Python program by VincentWeb");
                    }
                }
            }
        } finally {
    ...
    private void initComponents() {
        ...
        jFileChooser1.setCurrentDirectory(new java.io.File("C:\\"));
            ...
            playerList.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
            ...
            playerList.getColumnModel().getColumn(0).setPreferredWidth(30);
            playerList.getColumnModel().getColumn(1).setPreferredWidth(100);
            playerList.getColumnModel().getColumn(2).setPreferredWidth(30);
            ...
            rightPaneLayout.setHorizontalGroup(
                ...
                .addComponent(messScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 738, Short.MAX_VALUE)
                .addComponent(messIn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 738, Short.MAX_VALUE)
            );
            rightPaneLayout.setVerticalGroup(
                rightPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, rightPaneLayout.createSequentialGroup()
                    .addComponent(messScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 464, Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            jMenuItem54.setText("Change the YSF path");
            jMenuItem54.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    jMenuItem54ActionPerformed(evt);
                }
            });
            optionsMenu.add(jMenuItem54);
...
*/
    ...
    private void jMenuItem26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem37ActionPerformed
        messIn.setText(messIn.getText()+"/ban");
    }//GEN-LAST:event_jMenuItem37ActionPerformed

    private void jMenuItem27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem40ActionPerformed
        messIn.setText(messIn.getText()+"/blackout_off");
    }//GEN-LAST:event_jMenuItem40ActionPerformed

    private void jMenuItem28ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem26ActionPerformed
        messIn.setText(messIn.getText()+"/blackout_on");
    }//GEN-LAST:event_jMenuItem26ActionPerformed

    private void jMenuItem29ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem30ActionPerformed
        messIn.setText(messIn.getText()+"/collisions_off");
    }//GEN-LAST:event_jMenuItem30ActionPerformed

    private void jMenuItem30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem35ActionPerformed
        messIn.setText(messIn.getText()+"/collisions_on");
    }//GEN-LAST:event_jMenuItem35ActionPerformed

    private void jMenuItem31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem27ActionPerformed
        messIn.setText(messIn.getText()+"/day");
    }//GEN-LAST:event_jMenuItem27ActionPerformed

    private void jMenuItem32ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem38ActionPerformed
        messIn.setText(messIn.getText()+"/dispell");
    }//GEN-LAST:event_jMenuItem38ActionPerformed

    private void jMenuItem33ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem42ActionPerformed
        messIn.setText(messIn.getText()+"/flushUsers");
    }//GEN-LAST:event_jMenuItem42ActionPerformed

    private void jMenuItem34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem29ActionPerformed
        messIn.setText(messIn.getText()+"/kill_id");
    }//GEN-LAST:event_jMenuItem29ActionPerformed

    private void jMenuItem35ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem32ActionPerformed
        messIn.setText(messIn.getText()+"/kill_user");
    }//GEN-LAST:event_jMenuItem32ActionPerformed

    private void jMenuItem36ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem41ActionPerformed
        messIn.setText(messIn.getText()+"/landev_off");
    }//GEN-LAST:event_jMenuItem41ActionPerformed

    private void jMenuItem37ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem28ActionPerformed
        messIn.setText(messIn.getText()+"/landev_on");
    }//GEN-LAST:event_jMenuItem28ActionPerformed

    private void jMenuItem38ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem31ActionPerformed
        messIn.setText(messIn.getText()+"/night");
    }//GEN-LAST:event_jMenuItem31ActionPerformed

    private void jMenuItem39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem36ActionPerformed
        messIn.setText(messIn.getText()+"/radaralti=");
    }//GEN-LAST:event_jMenuItem36ActionPerformed

    private void jMenuItem40ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem34ActionPerformed
        messIn.setText(messIn.getText()+"/visib=");
    }//GEN-LAST:event_jMenuItem34ActionPerformed

    private void jMenuItem41ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem33ActionPerformed
        messIn.setText(messIn.getText()+"/windy=");
    }//GEN-LAST:event_jMenuItem33ActionPerformed

    private void jMenuItem42ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem39ActionPerformed
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        if (!evt.getActionCommand().equals("CancelSelection")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Cannot write to YSChat config file!\n"+ex, "YS_chat", JOptionPane.ERROR_MESSAGE);
            }
            try {ysc_cfg(file);} catch (Exception ex) {}
        }
    ...
    */
    ...
    private static javax.swing.JScrollPane messScroll;
